<?php
  ...
  if(isset($_POST['saveRecord'])) {
    ...
    if($name !='' && $mobile !='' && $email !='') {
      ...
      $Query ="insert into info(stu_id,stu_name,stu_mobile,stu_email) values($stu_id,'$name',$mobile,'$email')";
  ...
  if(isset($_POST['getRecord'])) {
    ...
    $fetchRec = mysqli_query($con,$sql) or die(mysqli_error($con));
